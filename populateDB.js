...
function createGenreAuthors(cb) {
    async.series([
        ...
        function(callback) {
          authorCreate('Shiv', 'Kumar Batalvi', '1936-07-23', '1973-05-06', callback);
        },
        function(callback) {
        ...
        function(callback) {
          genreCreate("Punjabi Poetry", callback);
        },
        ],
        // optional callback
        cb);
...
function createBooks(cb) {
    async.parallel([
        ...
        function(callback) {
          bookCreate('Loona', 'Modern Punjabi Poetry', 'ISBN2sdf', authors[5], [genres[3]], callback)
        }
        ],
        // optional callback
        cb);
